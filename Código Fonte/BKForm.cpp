...
#pragma link "CFrame"
#pragma resource "*.dfm"
TFBurguerKing *FBurguerKing;
//---------------------------------------------------------------------------
__fastcall TFBurguerKing::TFBurguerKing(TComponent* Owner)
	: TForm(Owner)
{
	valorTotal = 0;
	SQLTable2->MoveBy(1);
...
//---------------------------------------------------------------------------
void __fastcall TFBurguerKing::Voltar(TObject *Sender)
{
...
void __fastcall TFBurguerKing::Fechar(TObject *Sender, TCloseAction &Action)
{
	dynamic_cast <TForm*> (this->Owner)->Show();
}
//---------------------------------------------------------------------------

void __fastcall TFBurguerKing::Concluir(TObject *Sender)
{
