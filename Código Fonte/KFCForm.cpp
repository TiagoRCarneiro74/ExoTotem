...
TFKfc *FKfc;
//---------------------------------------------------------------------------
__fastcall TFKfc::TFKfc(TComponent* Owner)
	: TForm(Owner)
{
    valorTotal = 0;
	SQLTable2->MoveBy(1);
...
//---------------------------------------------------------------------------
void __fastcall TFKfc::Fechar(TObject *Sender, TCloseAction &Action)
{
    dynamic_cast <TForm*> (this->Owner)->Show();
}
//---------------------------------------------------------------------------

void __fastcall TFKfc::Voltar(TObject *Sender)
{
	dynamic_cast <TForm*> (this->Owner)->Show();
    delete this;
}
...
void __fastcall TFKfc::Concluir(TObject *Sender)
{
